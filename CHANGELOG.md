...
- Automatic pen plotter calibration marks: `src/calibration.ts` draws red crosshairs at the four canvas corners, derived from the canvas's physical size in any unit; new artworks generated by the wizard or CLI include the call and a "Show calibration marks" toggle by default
