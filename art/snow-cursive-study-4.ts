/**
 * Snow Cursive Study 4
 *
 * Part four of a multi-part study: study 3's postcard snowflake, now
 * free to turn about its center. The main flake stays centered, and the
 * open paper around it fills with a field of small line-drawn
 * snowflakes. One arm is grown from the center — a
 ...
 * its cell each flake fills. Rotation, in the Snowflake group, turns the
 * main flake about its center; the lettering and the field follow it.
 * The Snowflake and Background groups each open with a Randomize
 * control — a phrase that re-rolls the whole group within its limits —
 * the test case for the app's group randomizer.
 */
...
export const meta = {
  title: 'Snow Cursive Study 4',
  description:
    'A turnable 6 × 4 in postcard snowflake written in cursive, in a Voronoi field of small snowflakes',
};
